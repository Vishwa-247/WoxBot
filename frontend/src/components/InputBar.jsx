...
export default function InputBar({
  ...
  useEffect(() => {
    ...
    const delay = uploadResult?.summary ? 15000 : 5000;
  ...
  return (
    <div className="py-3">
      ...
      {uploadResult && (
        <div className="mb-2 px-3 py-2 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg text-emerald-700 dark:text-emerald-400 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="flex-1">
              ...
              {uploadResult.chunks_added
                ? ` — ${uploadResult.chunks_added} chunks indexed`
                : ""}
            </span>
            <button
          ...
          {uploadResult.summary && (
            <div className="mt-2 pt-2 border-t border-emerald-200 dark:border-emerald-800 text-emerald-600 dark:text-emerald-400 whitespace-pre-wrap">
              {uploadResult.summary}
            </div>
          )}
        </div>
